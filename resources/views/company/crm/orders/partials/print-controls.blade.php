<div class="print-controls">
    ...
    <label><input type="radio" name="doc_type" value="order" checked> Order</label><br>
    <label><input type="radio" name="doc_type" value="po"> Purchase Order</label>
    <hr>
    ...
    <hr>
    <label><input type="checkbox" class="toggle-section" data-target="docinfo" checked> Doc Info Section</label><br>
    <hr>
    <label><input type="checkbox" id="buyer_seller" class="toggle-section" data-target="customer" checked> Buyer &
        Seller Section</label><br>
    <label>
        <input type="checkbox" class="toggle-extra buyer_seller-checkbox" data-target="customer-gst" checked>
        GST
    </label><br> <label><input type="checkbox" class="toggle-extra buyer_seller-checkbox"
            data-target="customer-attn" checked>
    ...
    <label><input type="checkbox" class="toggle-extra" data-target="delivery-address" checked> Delivery
        Address Section</label><br>
    <hr>
    ...
    <label><input type="checkbox" class="column-toggle item_section" data-col="Cfv" checked> CFV</label>
    <hr>
    <label><input type="checkbox" id="total_section" class="toggle-section" data-target="section-totals" checked> Totals
        Section</label><br>

    <label> <input type="checkbox" class="toggle-extra total-sections" data-target="tax-percent" checked>
        Tax (%) </label>
    <br>

    <label>
        <input type="checkbox" class="toggle-extra total-sections" data-target="tax-amount" checked>
        Tax Amount
    </label>
    <br>
    <label>
    ...
    <div class="row mt-3">
        ...
        <div class="col-6" id="">
            <button type="button" id="downloadBtn" class="btn btn-danger btn-sm w-100" onclick="savePdf(this)">
