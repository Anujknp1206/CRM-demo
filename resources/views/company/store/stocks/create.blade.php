...
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('stock-ins.index', $company->id) }}">{{$label}}</a>
                        </li>
    ...
    <section class="content">
        <div class="card card-teal">
            ...
            <div class="card-body">
                <form id="stockForm" method="POST" action="{{ route('stock-ins.store', $company->id) }}" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Doc No</label>
                            <input type="text" name="doc_no" class="form-control" value="{{ $docNo }}" readonly>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text calendar-icon" data-target="#doc_date">
                                    ...
                                    <th class="align-middle">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            @can('add conditions')
                                                ...
                                                <button type="button" class="btn btn-outline-success btn-xs ml-1"
                                                    title="Add Condition" onclick="$('#conditionModal').modal('show')">
                                    ...
                                    <th class="align-middle">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            @can('add locations')
                                                ...
                                                <button type="button" class="btn btn-outline-success btn-xs ml-1"
                                                    title="Add Location" onclick="$('#locationModal').modal('show')">
                            ...
                            <tbody>
                                ...
                                <tr class="stock-row">
                                    ...
                                    <td>
                                        ...
                                        <select name="items[0][item_id]" class="form-control select2 item_select" required>
                                    ...
                                    <td>
                                        ...
                                        <select name="items[0][brand_id]" class="form-control select2 brand_select"
                                            required>
                                    ...
                                    <td>
                                        ...
                                        <select name="items[0][condition_id]" class="form-control select2 condition_select"
                                            required>
                                    ...
                                    <td>
                                        ...
                                        <select name="items[0][location_id]" class="form-control select2 location_select"
                                            required>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control base-unit-name bg-light" readonly>

                                        <input type="hidden" name="items[0][base_unit_id]" class="base-unit-id">
                                    ...
                                    <td>
                                        ...
                                        <select name="items[0][entry_unit_id]"
                                            class="form-control select2 entry-unit-select" required>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" step="0.000001" min="0" value="1"
                                            name="items[0][entry_quantity]" class="form-control entry-qty" required>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" step="0.000001" min="0" name="items[0][conversion_factor]"
                                            class="form-control conversion-factor" placeholder="1 BOX = ? PCS">

                                        <small class="text-muted conversion-help"></small>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control final-stock-qty bg-light" readonly>

                                        <input type="hidden" name="items[0][stock_quantity]" class="stock-quantity-hidden">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="items[0][rate]" class="form-control" step="0.01" min="0"
                                            required>
            ...
            {{-- REMOVE --}}
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            class="form-control base-unit-name bg-light"
                                                                            readonly
                                                                        >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input
                                                                            type="text"
                                                                            class="form-control final-stock-qty bg-light"
                                                                            readonly
                                                                        >
                    ...
                    <button type="submit" id="saveStockBtn" class="btn btn-success">
    ...
    <script>
        ...
        $('#add_row').on('click', function () {
            ...
            */
            ...
            $row.find('select.select2:not(.item_select)').select2({
        ...
        $('#unitForm').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.entry-unit-select').each(function () {
                        $(this).append(option);
                    });

                    $('.entry-unit-select').trigger('change.select2');
